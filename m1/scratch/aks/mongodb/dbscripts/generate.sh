...
kubectl create secret generic shared-bootstrap-data --namespace dev --from-file=keyfile=$TMPFILE
rm $TMPFILE
...
kubectl apply -f ../dbresources/mongodb-service.yaml --validate=false --namespace dev
sleep 5
